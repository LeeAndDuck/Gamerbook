...
<body>
                        ...
                        <div class="swiper-slide box">
                            <form action="" method="post">
                                <div class="icons">
                                    ...
                                    <a href="product_detail.php?id=<?= $fetch_products['id'] ?>" class="fas fa-eye"></a>
                                </div>
                                <img src="assets/uploaded_img/<?php echo $fetch_products['image']; ?>" alt="">
                                <div class="name"><?php echo $fetch_products['name']; ?></div>
                                <div class="price"><?php echo $fetch_products['price']; ?>.000₫/-</div>
    ...
    <section class="home-contact">
        <div class="content">
            ...
            <a href="contact.php" class="white-btn box-shadow">Liên hệ</a>
        </div>
    </section>
